...
function redir(){
    ...
    if(hosSel.value == "النساء و التوليد"){
        nBtn.setAttribute("href", "hospital1-department1");
    }
    if(hosSel.value == "العناية"){
        nBtn.setAttribute("href", "hospital1-department2");
    }
    if(hosSel.value == "الأطفال"){
        nBtn.setAttribute("href", "hospital1-department3");
    }
}